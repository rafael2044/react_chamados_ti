...
const RelatorioUnidadePDF = ({ dataInicio, dataFim, dados }) => {
        ...
        <View style={styles.table}>
          ...
          {dados?.map((unidade, index) => (
            <View 
              ...
              key={unidade.nome || index} // Usar key mais robusta
              wrap={false}
            >
          ...
          <View style={styles.tableRowTotal} wrap={false}>
            ...
            <View style={styles.tableColQty}>
              <Text style={styles.tableCellTotalValue}>
                {dados?.reduce((sum, unidade) => sum + unidade.total, 0)}
              </Text>
            </View>
          </View>
        </View>
...
export default RelatorioUnidadePDF;